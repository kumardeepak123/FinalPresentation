...
namespace CPMS.Migrations
{
    ...
    [Migration("20221220093126_first")]
    partial class first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CPMS.Models.Team_Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CPMS.Models.Team_Employee", b =>
                {
                    b.HasOne("CPMS.Models.Employee", "_Employee")
                        .WithOne("_Team_Employees")
                        .HasForeignKey("CPMS.Models.Team_Employee", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CPMS.Models.Team", "_Team")
                        .WithOne("_Team_Employees")
                        .HasForeignKey("CPMS.Models.Team_Employee", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
